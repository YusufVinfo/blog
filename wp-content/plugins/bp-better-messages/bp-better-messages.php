    ...
    class Better_Messages
    {
        ...
        public function get_script_variables()
        {
            ...
            $script_variables = array(
                ...
                'locale'             => $locale,
                'stickers'           => !empty($this->settings['stipopApiKey']),
                'gifs'               => !empty($this->settings['giphyApiKey']),
                ...
                'guests'             => Better_Messages()->guests->guest_access_enabled(),
            );
            ...
            $script_variables['mutedThreads'] = Better_Messages()->functions->get_user_muted_threads( get_current_user_id() );
            ...
            if ( is_user_logged_in() ) {
                ...
                $script_variables['guestSupport'] = ( $this->settings['supportChat'] == '1' ? '1' : '0' );
            }
